...
flags.DEFINE_string("pretrain_checkpoint",
                    "../gpt-2/models/117M/model.ckpt",
                    "OpenAI pretrained model checkpoint. Ignored if "
                    "'--checkpoint' is specified.")
flags.DEFINE_string("pretrained_model_dir", "../gpt-2/models/117M/",
...
flags.DEFINE_bool("supervised", True, "Whether supervised training.")
...
def main(_):
    ...
    def _test_epoch(sess, step=None):
        ...
        tx.utils.write_paired_text(
            _all_input_text, _all_samples_text, output_file, mode='s')
